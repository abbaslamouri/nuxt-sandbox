...
<template>
  <div class="admin-product-variant row">
    ...
    <div class="actions td">
      <button class="btn" @click.prevent="showActions = emit('showActionsEmitted', !showActions)">
        <IconsMoreHoriz />
      </button>
    ...
    <Alert v-if="showDeleteVariantAlert" @ok="deleteVariant" @cancel="$emit('showDeleteVariantAlertEmitted', false)">
